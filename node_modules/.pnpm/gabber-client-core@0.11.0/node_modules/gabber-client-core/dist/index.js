...
var TrackVolumeVisualizer = class {
  ...
  setTrack(track) {
    ...
    const { analyser, cleanup, calculateVolume } = (0, import_livekit_client.createAudioAnalyser)(track, {
      fftSize: 256,
...
var PersonaApiFp = function(configuration) {
  ...
  return {
    ...
    async createPersona(createPersonaRequest, xHumanId, options) {
      ...
      return (axios, basePath) => createRequestFunction(localVarAxiosArgs, import_axios5.default, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * 
     * @summary Delete a persona
...
var RealtimeApiFp = function(configuration) {
  ...
  return {
    ...
    async endRealtimeSession(session, xHumanId, options) {
      ...
      return (axios, basePath) => createRequestFunction(localVarAxiosArgs, import_axios6.default, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * End the RealtimeSession with the given identifier. 
     * @summary Get a RealtimeSession.
...
var ScenarioApiFp = function(configuration) {
  ...
  return {
    ...
    async createScenario(createScenarioRequest, options) {
      ...
      return (axios, basePath) => createRequestFunction(localVarAxiosArgs, import_axios7.default, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * 
     * @summary Delete a scenario
...
var SessionApiFp = function(configuration) {
  ...
  return {
    ...
    async apiV1SessionListGet(xHumanId, human, options) {
      ...
      return (axios, basePath) => createRequestFunction(localVarAxiosArgs, import_axios8.default, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * 
     * @summary End a session
...
var UsageApiFp = function(configuration) {
  ...
  return {
    ...
    async createUsageToken(usageTokenRequest, xHumanId, options) {
      ...
      return (axios, basePath) => createRequestFunction(localVarAxiosArgs, import_axios9.default, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * Gets the usage limits of a token
     * @summary Get usage limits
...
var VoiceApiFp = function(configuration) {
  ...
  return {
    ...
    async cloneVoice(name, language, file, xHumanId, options) {
      ...
      return (axios, basePath) => createRequestFunction(localVarAxiosArgs, import_axios10.default, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * 
     * @summary Delete a voice
...
var RealtimeSessionEngine = class {
  constructor({
    ...
    this.id = null;
    this.livekitRoom = new import_livekit_client2.Room();

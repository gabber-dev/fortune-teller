...
export declare const LLMApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listContextMessages: (context: string, xHumanId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     * @summary Get a list of llms
     * @param {string} [xHumanId] When using x-api-key authentication, this header is used to scope requests to a specific human.
...
export declare const LLMApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listContextMessages(context: string, xHumanId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListContextMessages200Response>>;
    /**
     *
     * @summary Get a list of llms
     * @param {string} [xHumanId] When using x-api-key authentication, this header is used to scope requests to a specific human.
...
export declare class LLMApi extends BaseAPI {
     ...
     * @memberof LLMApi
     */
    createContextMessage(context: string, contextMessageCreateParams: ContextMessageCreateParams, xHumanId?: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<ContextMessageCreateParams, any>>;
    /**
     * Retrieve the Context with the given identifier.
     * @summary Retrieve a Context.
     * @param {string} context The unique identifier of the Context.
     ...
     * @memberof LLMApi
     */
    getContextMessage(context: string, message: string, xHumanId?: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<ContextMessageCreateParams, any>>;
    /**
     *
     * @summary Get a list of llms
     * @param {string} llm
     ...
     * @memberof LLMApi
     */
    listContextMessages(context: string, xHumanId?: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<ListContextMessages200Response, any>>;
    /**
     *
     * @summary Get a list of llms
     * @param {string} [xHumanId] When using x-api-key authentication, this header is used to scope requests to a specific human.
